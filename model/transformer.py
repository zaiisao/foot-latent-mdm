...
class CrossAttentionEncoder(Module):
    ...
    def forward(self, src: Tensor, mask: Optional[Tensor] = None,
                ...
                time_emb: Optional[Tensor] = None) -> Tensor:
        ...
        # print(f"[ENCODER LEVEL] Loop Start:")
        # print(f"   > Received time_emb? {time_emb is not None}")
        # print(f"   > Received memory? {memory is not None}")
...
class CrossAttentionEncoderLayer(Module):
    ...
    def forward(self, src: Tensor, src_mask: Optional[Tensor] = None, 
        ...
        #     # Check mean value before addition
        #     before = src.mean().item()
        #     src = src + time_emb 
        #     after = src.mean().item()
        #     print(f"[LAYER LEVEL] Time Injection:")
        #     print(f"   > Added Time Emb? Yes.")
        #     print(f"   > Mean Value Shift: {before:.4f} -> {after:.4f} (Should change)")
        # else:
        #     print(f"[LAYER LEVEL] ❌ WARNING: time_emb is None inside the layer!")
